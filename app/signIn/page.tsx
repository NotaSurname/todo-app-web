...
export default function SignIn() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-white dark:bg-[#0A0A0A]">
            <form className="border border-gray-400/50 py-10 rounded-lg w-[500px] h-auto">
                ...
                <div className="flex flex-row space-x-3 px-5">
                    <Input type={"text"} label={"Prénom"} id={"firstName"} size={"w-full mb-5"}/>
                    <Input type={"text"} label={"Nom"} id={"lastName"} size={"w-full mb-5"}/>
                </div>
                <div className="px-5">
                    ...
                    <Input type={showConfirmPassword ? "text" : "password"} label={"Confirmer votre mot de passe"} id={"password"} size={"w-full mb-5"}/>
                    <label className="inline-block relative select-none cursor-pointer
                           mb-5
                           after:content-[''] after:absolute after:left-0
                           after:-bottom-0.5 after:h-[2px] after:w-full
